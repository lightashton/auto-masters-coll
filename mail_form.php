...
// 	}
	...
	$toEmail = "autoglassquotes@yahoo.com, automasterscollision37@gmail.com";
	//$mailHeaders = "From: " . $user_name . "<" . $user_email . ">\r\n";
	$headers = "$name = $name;" . "\r\n";
    $headers = "MIME-Version: 1.0" . "\r\n";
    $headers .= "Content-type:text/thank-you.html;charset=UTF-8" . "\r\n";
	...
	if (mail($toEmail, "Auto Masters Collision", $mailBody, $headers)) {
